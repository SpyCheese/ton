...
class Overlay : public td::actor::Actor {
 public:
  ...
  static td::actor::ActorOwn<Overlay> create_private(
      ...
      td::actor::ActorId<adnl::AdnlSenderInterface> atcp, td::actor::ActorId<dht::Dht> dht_node,
      adnl::AdnlNodeIdShort local_id, OverlayIdFull overlay_id, std::vector<adnl::AdnlNodeIdShort> nodes,
      std::unique_ptr<Overlays::Callback> callback, OverlayPrivacyRules rules, std::string scope,
      OverlayOptions opts = {});
