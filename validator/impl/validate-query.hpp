...
class ValidateQuery : public td::actor::Actor {
 ...
 private:
  ...
  std::function<td::optional<StorageStatCache::CacheEntry>(const block::Account&)> storage_stat_cache_;
  std::vector<StorageStatCache::CacheEntry> storage_stat_cache_update_;
  ...
  void after_get_storage_stat_cache(
