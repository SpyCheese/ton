...
nix-build linux-x86-64-toncryptolib-debug.nix
mkdir -p artifacts/include/
cp ./result/lib/libton_crypto_lib.so artifacts/libton_crypto_lib.so
cp -r ./result/include/crypto/ ./result/include/common/ ./result/include/tdutils/ ./result/include/ton/ artifacts/include/
